            ...
            case 'GIVE_OC':
                ...
                if (user.pushToken) {
                    await sendPushNotification(
                        ...
                        { type: 'WALLET_UPDATE', mediaUrl: user.profilePic?.url }
                    );
                }
                ...
                if (updatedPost.authorUserId) {
                    ...
                    if (payload.status == "approved") {
                        if (author.totalPost == 0) {
                            author.aura = (author.aura || 0) + 50;
                        } else {
                            author.aura = (author.aura || 0) + 15;
                        }
                        await author.save();
                    }
                    if (author && author.pushToken) {
                        ...
                        await sendPushNotification(author.pushToken, title, body, { type: 'POST_STATUS', postId: updatedPost._id, mediaUrl: updatedPost.mediaUrl, authorPfp: author.profilePic?.url });
                    }
                }
            ...
            case 'DELETE_POST':
                ...
                if (deletedPost) {
                    ...
                    if (author && author.pushToken) {
                        ...
                        await sendPushNotification(author.pushToken, title, body, { type: 'POST_STATUS', postId: deletedPost._id, mediaUrl: deletedPost.mediaUrl, authorPfp: author.profilePic?.url });
                    }
                }
                ...
                if (editedPost.authorUserId && payload.notifyAuthor) {
                    ...
                    if (author && author.pushToken) {
                        await sendPushNotification(
                            ...
                            { type: 'POST_EDIT', postId: editedPost._id, mediaUrl: editedPost.mediaUrl, authorPfp: author.profilePic?.url }
                        );
                    }
                }
