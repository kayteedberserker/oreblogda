	...
	try {
		...
		if (action === "view") {
			...
			const isBotRequest = async (req, ip) => {
				...
				const botIPPrefixes = [
  // Google crawlers
  "66.102.", "66.249.", "64.233.", "34.", "65.0", "74.125.", "142.250.", "172.217.", "209.85.", "216.58.",
  
  // Facebook crawlers
  "31.13.", "66.220.", "69.171.", "15.206.", "52.66.", "13.", "43.", "3.", "157.240.", "173.252.", "18.", 
  
  // Apple / iCloud crawler (optional)
  "17.", "::1", "198.7.237.195", "198.7.237.196", "198.7.237.197", "102.67.30.228","198.7.237.198", "204.", "198.7.237.199", "137.184.", " 50.18.", "54.", "35.", "23.27", "13.5", "196.49.26.134"
];
