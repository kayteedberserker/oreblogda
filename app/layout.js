...
export default function RootLayout({ children }) {
	return (
		<html lang="en" suppressHydrationWarning>
			...
			{/* ⚡️ Centralized Base Theme Protocol */}
			<body className={`${spaceGrotesk.className} antialiased min-h-screen bg-app-bg dark:bg-app-dark-bg text-app-text dark:text-app-dark-text selection:bg-app-accent selection:text-white transition-colors duration-500`}>
				<ThemeProvider attribute="class" defaultTheme="system" enableSystem={true}>
					...
					>
						...
						{/* ⚡️ Swapped raw gradients for theme-aware backgrounds, maintaining the ambient effect */}
						<div className="mt-16 relative min-h-screen flex flex-col bg-gradient-to-br from-app-bg via-app-card to-blue-50/30 dark:from-app-dark-bg dark:via-app-dark-card dark:to-[#0d1117] transition-colors duration-500">
