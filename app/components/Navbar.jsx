...
const Navbar = () => {
    ...
    return (
        <nav
            className={`w-full fixed top-0 left-0 z-80 transition-all duration-500 border-b ${systemTheme === "dark"
                ...
                <div className="flex justify-between h-16 items-center">
                        ...
                        {links.map((link) => {
                            ...
                            return (
                                <div key={link.name} className="relative group">
                                    <Link
                                        href={link.href}
                                        className={`text-[11px] font-black uppercase tracking-[0.2em] transition-all duration-300 py-2 flex items-center gap-1 ${isActive
                    ...
                    <div className="md:hidden flex items-center">
                        <button
                            ...
                            className={`p-2 rounded-lg transition-all ${isMobileOpen
            ...
            <AnimatePresence>
                {isMobileOpen && (
                    <motion.div
                        ...
                        className={`md:hidden fixed inset-0 top-16 z-[99] overflow-hidden ${systemTheme === "dark"
                                ...
                                return (
                                    ...
                                    >
                                        <Link
                                            ...
                                            className={`text-4xl font-black italic uppercase tracking-tighter transition-all ${isActive
