          ...
          <div className="flex flex-col gap-8">
            {uniquePosts.map((post, index) => (
              <div key={post._id} className="relative group">
                ...
                {/* AD TERMINAL SLOT */}
                {index % 2 === 1 && (
                  <div className="my-10 w-full p-4 border border-dashed border-gray-200 dark:border-gray-800 rounded-3xl flex flex-col justify-center bg-gray-50/50 dark:bg-white/5">
