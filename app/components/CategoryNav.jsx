...
export default function CategoryNav() {
  ...
  return (
    <nav className="flex space-x-2 sm:space-x-3 justify-center overflow-x-auto py-2 px-2 sm:px-4 bg-gray-100 dark:bg-gray-800 rounded-md shadow-sm">
      {categories.map((cat) => {
        ...
        return (
          <Link
            ...
            className={`inline-flex items-center px-2 text-sm py-1 rounded-md font-medium whitespace-nowrap ${isActive
