...
export default function CategoryNav() {
  ...
  return (
    <nav className="flex space-x-1 sm:space-x-3 justify-center overflow-x-auto py-2 px-3 sm:px-4 bg-gray-100 dark:bg-gray-800 rounded-md shadow-sm">
      {categories.map((cat) => {
        ...
        return (
          <Link
            ...
            className={`inline-flex items-center px-3 py-1 rounded-md font-medium whitespace-nowrap ${isActive
