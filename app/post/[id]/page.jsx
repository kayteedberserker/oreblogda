...
<div className="absolute bottom-10 right-10 w-56 h-56 bg-pink-300 dark:bg-pink-700 opacity-20 rounded-full blur-3xl animate-pulse"></div>  {/* Page SEO */}
<NextSeo
title={post?.title}
...
<div className="md:col-span-2">    
  ...
  </div>      <ToastContainer autoClose={1500} />    
</div>    
</motion.div>  );
}
